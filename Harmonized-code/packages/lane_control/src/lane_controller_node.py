...
class LaneControllerNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.loginfo("Inside constructor-start.")
        ...
        self.loginfo("outside constructor-contoller-start.")
        ...
        self.sub_centres = rospy.Subscriber(
            "/sapduckie/vehicle_detection_node/centers",
            VehicleCorners,
        ...
        self.sub_apriltag = rospy.Subscriber(
            "/sapduckie/apriltag_detector_node/detections",
        ...
        self.log("Initialized-5!")
        # LED control
        rospy.wait_for_service("/sapduckie/led_emitter_node/set_pattern")
        self.led_svc = rospy.ServiceProxy(
            "/sapduckie/led_emitter_node/set_pattern", ChangePattern,
        )
        self.log("Initialized-6!")
...
if __name__ == "__main__":
    ...
    rate = rospy.Rate(10)
    node.printLog("Outside controller Drive.")
    while not rospy.is_shutdown():
        node.printLog("Inside controller Drive.")
        node.drive()
        rate.sleep()
